...
import 'package:cattleplus/UI/display_history.dart';
      ...
      builder: (context, localstate) {
        return Scaffold(
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => AddCattle(email: email)));
            },
          ...
          appBar: AppBar(
            leading: IconButton(
                onPressed: () {
                  context.read<LocalizeCubit>().change_lang();
                },
                icon: Icon(FontAwesomeIcons.language)),
            title: Text(Strings.map["Home"]![localstate.index]),
          ),
          body: Padding(
                              ...
                              return ListTile(
                                  ...
                                  leading: get_icon(
                                      ...
                                      homestate.cattle_list[index]["lastState"]
                                          .toLowerCase()),
                                  title: Center(
                                      child: Text(homestate.cattle_list[index]
                                          ["name"])),
                                  trailing: get_icon2(homestate
                                      .cattle_list[index]["lastState"]));
                            }),
                      );
                    } else {
                      return Container(
